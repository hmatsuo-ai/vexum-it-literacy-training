...
- `08_ai-tools.md`：生成AIに共通する使い方・性能・外部連携（NotebookLMは紹介のみ）
- `09_prompting.md`：プロンプト
- `10_agents-and-vibe-coding.md`：AIエージェント・バイブコーディング
- `11_ai-security.md`：AI・情報セキュリティ

**一般的な生成AI製品を製品別テーマとして教えない。** モデル名、製品機能、料金、UIの暗記ではなく、どの生成AIにも共通する原理・判断軸を教える。

ただし、**NotebookLMは「資料を中心に質問・要約・比較するAI活用」の具体例として短く紹介する。** 必須ツールとして習得させるのではなく、教科書1ページ以内・説明5分以内を目安とし、NotebookLM単体の操作テストは行わない。
