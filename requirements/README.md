...
- `07_ai-overview.md`：LLMとは何か（約4ページ）
...
Theme 07は**LLMそのものの理解に集中する**。

- LLMとは何か
- なぜ自然な文章を作れるのか
- 検索エンジン・正解データベースとの違い
- 何でも最新・正確に知っているわけではないこと
- なぜもっともらしい間違いが起こるのか
- なぜ人による確認が必要なのか

トークン、Embedding、Transformer / Attention、Training / Inference、コンテキストウィンドウ、RAG、Tool / Function Calling等はTheme 07の学習・テスト対象にしない。
