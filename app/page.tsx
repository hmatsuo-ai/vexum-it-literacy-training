...
const missions: Mission[] = [
  ...
  },
  {
    ...
    copy: "AIへの理解を深める近道は、自分で課題を設定し、実際にAIを使って試してみることです。世の中で発信されているAIの活用事例を参考にし、わからない部分はAIに質問して、自分が理解できるレベルまで噛み砕きながら、自分の環境で再現してみてください。見るだけで終わらず、実際に手を動かすことで理解は深まります。",
