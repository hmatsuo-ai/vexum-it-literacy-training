...
const missions: Mission[] = [
  {
    ...
    points: ["業務内容のヒアリング", "課題を整理する", "解決し、使ってもらう", "現場の声で改善する"],
  ...
  },
  {
    ...
    copy: "AIへの理解を深める近道は、実際に手を動かすことです。気になるAI活用例を見つけたら、分からない部分はAIに聞きながら、自分の環境で再現してみましょう。今日学んだことを持ち帰り、自分なりの課題で試してみてください。",
  ...
  },
  {
    ...
    group: "CREATE",
    title: "言語化・要件定義",
    lead: "頭の中のイメージを、作業できる要件定義に変える。",
    future: "相手とAIに、仕事を正確に伝える力",
    copy: "良い要件定義や指示は魔法の一文ではありません。目的と条件を具体的にし、AIと対話しながら不足を埋め、完成物を人が評価します。",
