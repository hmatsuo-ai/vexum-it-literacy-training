    ...
    <main className="gate">
      ...
      <section className="intro">
        ...
        <div className="journey-copy">
          <p>
            このセミナーでは、AIが動く基本的な仕組みから、情報の調べ方、資料の扱い方、指示の伝え方、AIと一緒にものをつくる方法まで、仕事と生活につながる形で幅広く学びます。
          </p>
          <p>
            ただし、AIのツールや機能は今も変わり続けています。一度のセミナーだけで、すべての最新ツールを使いこなせるようになるわけではありません。
          </p>
          <p>
            AIへの解像度を高める一番の近道は、今日知ったことを入口に、自分の手でツールを使ってみることです。仕事の整理だけでなく、調べもの、旅行の計画、文章づくりなど、身近な場面で試すほど、AIにできることと、人が判断すべきことが見えてきます。
          </p>
          <strong>今日の学びを、今日から使う。</strong>
        </div>
      </section>
